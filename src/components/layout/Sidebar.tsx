...
import { BarChart3, CalendarCheck, FolderOpen, Search } from "lucide-react";
  ...
  return (
    <aside className="hidden h-screen w-80 flex-col border-r border-white/5 bg-brand-midnight/90 px-6 py-8 lg:flex">
          ...
          return (
            ...
            >
              <span className="flex items-center gap-3">
                <span className="grid h-9 w-9 place-items-center rounded-xl bg-brand-gold/10 text-brand-gold">
                  <Icon size={18} />
                </span>
                {item.label}
              </span>
      ...
      <div className="mt-auto">
        ...
        <div className="flex items-center gap-3 rounded-3xl border border-brand-gold/20 bg-brand-deep/70 p-4">
